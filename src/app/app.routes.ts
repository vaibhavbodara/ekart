...
import { ChechoutComponent } from './customer/buyer/chechout/chechout.component';
...
export const routes: Routes = [
    ...
    {
        path: '', children: [
            { path: "seller-dashboars", component: SellerDashboardComponent },
    ...
    // if any path not match that time this astrick path component hit
